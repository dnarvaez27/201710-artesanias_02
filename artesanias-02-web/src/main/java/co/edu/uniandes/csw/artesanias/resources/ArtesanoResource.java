...
public class ArtesanoResource {
    ...
    /**
     * Crea un Artesano en el sistema, cuya información es dada por parámetro a
     * través de un DTO
     *
     * @param dto DTO con la información del Artesano
     * @return DTO con la información del Artesano
     * @throws BusinessLogicException Si no cumple con los requisitos mínimos
     * para su creación. (400 BAD REQUEST)
     */
    @POST
     ...
     *
     * @return Lista de DTO's con la información de los Artesanos que hacen
     * parte del sistema
     */
    @GET
     ...
     * @throws BusinessLogicException Si el artesano con el id dado, no existe
     * en el sistema (404 NOT FOUND)
     */
    @GET
    @Path("{id: \\d+}")
