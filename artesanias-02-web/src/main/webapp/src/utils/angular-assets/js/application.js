...
angular.module('newApp').factory('applicationService', ['pluginsService', function (pluginsService) {
    ...
    applicationService.createSidebarTop = createSidebarTop;
    applicationService.removeSidebarTop = removeSidebarTop;
    ...
    applicationService.toggleSidebarTop = toggleSidebarTop;
